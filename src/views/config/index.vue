  ...
  methods: {
    ...
    upsert() {
      if (document.querySelector(".task-modal").innerHTML == "Edit Task") {
        let result = this.todoList.findIndex(
          (o) => o.id == document.getElementById("taskid-input").value
        );
        this.todoList[result].todo = document.getElementById("task-title-input").value;
        this.todoList[result].dueDate = document.getElementById(
          "task-duedate-input"
        ).value;
        var editimage = [];
    ...
    if (addNewProject) {
      document.getElementById("addNewProject").addEventListener("click", function () {
        ...
        const projectlisthtml =
          ...
          uniqueid +
          '">\
                        <BLink data-bs-toggle="collapse" href="#projectCollapse-' +
          uniqueid +
        ...
        <BRow class="mb-4">
          <div order="1" class="col-auto d-block d-lg-none">
            <BButton
              ...
              class="btn btn-icon btn-sm fs-16 file-menu-btn"
            >
        ...
        <div class="p-3 bg-light rounded mb-4">
          <BRow class="g-2">
            <BCol lg="6">
              ...
              <BButton variant="primary" class="createTask" @click="create">
                <i class="ri-add-fill align-bottom"></i> Add Tasks
              </BButton>
            </BCol>
          </BRow>
                    ...
                    <td>
                      <div class="hstack gap-2">
                        <BButton
                          ...
                          size="sm"
                          class="remove-list"
                          data-remove-id="{{singleTodo.id}}"
                          @click="deletedata(singleTodo)"
                        ...
                        <BButton
                          ...
                          size="sm"
                          class="edit-list"
                          data-edit-id="{{singleTodo.id}}"
                          @click="editdata(singleTodo)"
      ...
      >
        ...
        <div class="hstack gap-2 justify-content-end">
          <BButton
            ...
            ><i class="ri-close-line align-bottom"></i> Close</BButton
          >
          <BButton type="submit" variant="primary" id="addNewProject"
            >Add Project
          </BButton>
        </div>
      </BForm>
    ...
    >
      ...
      <BForm autocomplete="off" action="" id="creattask-form">
          ...
          >
            <template v-slot="{ values, isOpen }">
              <span class="multiselect__single" v-if="values.length && !isOpen"
                >Assigned To<b>{{ values.length }}</b> Members</span
              >
            </template>
          </Multiselect>
        </div>
        ...
        <div class="hstack gap-2 justify-content-end">
          ...
          <BButton type="button" variant="primary" id="addNewTodo" @click="upsert"
            >Add Task</BButton
          >
        </div>
      </BForm>
